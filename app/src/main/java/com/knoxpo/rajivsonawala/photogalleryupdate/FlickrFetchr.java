...
public class FlickrFetchr {
    ...
    private static final String FETCH_RECENT_PHOTO="flickr.photos.getRecent";

    private static final String API_KEY = "9fc1541e40ed9fbed18da0879c0f0000";
    ...
    public List<GalleryItem> fetchRecentPhotos(){
        ...
        String url=buildUrl(FETCH_RECENT_PHOTO,null);
